...
public class WriteExcelFileUser implements IExcelFile {
  ...
  public void writeHeader() {
    ...
    List<String> headersUser = new ArrayList<>(Arrays.asList("User ID", "Username", "Password", "Email", "Full " +
        "name", "Phone", "Avatar", "Mark", "Birth day", "DeleteFlag"));
  ...
  public void writeData() {
    ...
    for (User user : users) {
      ...
      cell.setCellValue(user.getDeleteFlag().toString());
  ...
  public void export(HttpServletResponse res) throws IOException {
    ...
    if (res != null) {
      ...
      FileOutputStream out = new FileOutputStream(new File(CommonConstant.PATH_USER_FILE));
      workbook.write(out);
      workbook.close();
      out.close();
    }
