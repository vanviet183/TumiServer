...
public class WriteExcelFileCourse implements IExcelFile {
  ...
  public void writeHeader() {
    ...
    List<String> headers = new ArrayList<>(Arrays.asList("Course ID", "Name", "Price", "Description", "Avatar",
        "Process", "Status", "CategoryID"));
  ...
  public void writeData() {
    ...
    for (Course course : courses) {
      ...
      cell.setCellValue(course.getDeleteFlag().toString());
  ...
  public void export(HttpServletResponse res) throws IOException {
    ...
    if (res != null) {
      ...
      FileOutputStream out = new FileOutputStream(new File(CommonConstant.PATH_COURSE_FILE));
      workbook.write(out);
      workbook.close();
      out.close();
    }
